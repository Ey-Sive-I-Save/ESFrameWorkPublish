...
- Missing, stale, or contradictory receipts block only the evidence claim they support. When execution uses AIBrain they force a new plan; they do not revoke the current user's direct authorization for bounded project work.
