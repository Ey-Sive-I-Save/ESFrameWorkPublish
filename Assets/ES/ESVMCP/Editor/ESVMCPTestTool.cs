...
namespace ES.VMCP
{
    ...
    public class ESVMCPTestTool : EditorWindow
    {
        ...
        [MenuItem("Tools/ESVMCP/测试工具/打开测试窗口")]
        ...
        private void ExecuteJson()
        {
            try
            {
                ...
                if (sceneMemory == null)
                {
                    Debug.LogWarning("[ESVMCP] 场景中未找到ESVMCPMemory组件，将创建临时实例");
    ...
    public static class ESVMCPQuickExecute
    {
        ...
        [MenuItem("Tools/ESVMCP/测试工具/执行 - 基础场景示例")]
        ...
        [MenuItem("Tools/ESVMCP/测试工具/执行 - 记忆系统示例")]
        ...
        [MenuItem("Tools/ESVMCP/【批量执行】", priority = 5)]
