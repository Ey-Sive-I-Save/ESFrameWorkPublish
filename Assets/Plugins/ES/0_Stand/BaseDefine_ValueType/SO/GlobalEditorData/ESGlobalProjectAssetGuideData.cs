...
namespace ES
{
    ...
    public partial class ESGlobalProjectAssetGuideData : ESEditorGlobalSo<ESGlobalProjectAssetGuideData>
    {
        ...
        private static readonly StandardGuideRule[] StandardGuideRules =
        {
            ...
            new StandardGuideRule("Assets/Scripts/ESLogic/Runtime/Interaction", "Interaction", "共享交互协议目录", "保存跨 Entity、Item、NPC、Mountable 使用的交互目标协议和通用目标实现。", "Entity 只拥有交互发起模块；Item 等目标业务仍由各自领域拥有。此目录不得发展成与 Entity/Item 并列的业务 Domain 根。", "Interaction", "Shared"),
