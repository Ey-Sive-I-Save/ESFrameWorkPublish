    ...
    public partial class ESGlobalProjectAssetGuideData : ESEditorGlobalSo<ESGlobalProjectAssetGuideData>
    {
        ...
        private void EnsureStandardGuideRecords()
        {
            string[] importantPaths =
            {
                ...
                "Assets/Scripts/ESLogic/Runtime/Skill/Timeline",
        ...
        private static readonly StandardGuideRule[] StandardGuideRules =
        {
            ...
            new StandardGuideRule("Assets/Scripts/ESLogic/Runtime/Skill/Timeline", "Skill Timeline", "Skill timeline folder", "Folder responsibility: stores formal skill timeline tracks, clips and runtime structures.", "Folder rule only. Script duties must be hardcoded separately.", "Skill", "Timeline", "Track"),
            new StandardGuideRule("Assets/Scripts/ESLogic/Runtime/Skill/TrackItemAndClip/Tools", "Skill Timeline", "Track sampling and editor play tools folder", "Folder responsibility: stores editor preview, sampling and sequence play support.", "Folder rule only. Script duties must be hardcoded separately.", "Skill", "Sampler", "Preview"),
            new StandardGuideRule("Assets/Scripts/ESLogic/Runtime/Skill/TrackItemAndClip", "Skill Timeline", "Legacy track and clip compatibility folder", "Folder responsibility: keeps legacy skill track/clip/sampler support.", "Folder rule only. Script duties must be hardcoded separately.", "Skill", "Track", "Compatibility"),
