...
/// <summary>
/// ESAssetRefer 使用示例 - 简化版
/// ES 资源系统的便捷引用工具，依赖 ESResLoader 和 ESResSource 完成加载
/// </summary>
public class ESAssetReferExample : MonoBehaviour
{
    ...
    public ESAssetReferMaterial material;
    ...
    void OnDestroy()
    {
        // ESAssetRefer 不需要手动释放，ES 资源系统会自动管理引用计数
...
/// <summary>
/// 最佳实践：在 ScriptableObject 中使用 ESAssetRefer
/// </summary>
