...
namespace ES
{
    ...
    public static partial class ESDesignUtility
    {
        ...
        public static class ColorSelector
        {
            ...
            /// <summary>
            /// 通过ColorName枚举获取Color
            /// </summary>
            public static Color GetColor(ColorName colorName)
            {
                // 直接用枚举名查字典
                if (normalColors.TryGetValue(colorName.ToString(), out var c))
                    return c;
                return Color.white;
            }
            ...
            {
                return normalColors.TryGetValue(colorName.ToString(), out color);
            }
            ...
            public static readonly Color 橄榄 = new Color(0.5f, 0.5f, 0f);
            public static readonly Color 藏青 = new Color(0.1f, 0.2f, 0.4f);
