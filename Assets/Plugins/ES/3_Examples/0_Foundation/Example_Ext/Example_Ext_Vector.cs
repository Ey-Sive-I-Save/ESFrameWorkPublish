...
namespace ES.Samples{
    public class Example_Ext_Vector : MonoBehaviour
    {
        void Update()
        {
            ...
            // 1. 三轴分别相乘
            var mul = pos._MultiVector3(other); // 各分量相乘
            Debug.Log($"_MultiVector3: {mul} // 各分量相乘");
            ...
            // 6. 分量乘系数
            Debug.Log($"_WithYMulti: {pos._WithYMulti(2f)} // Y分量乘2");
            Debug.Log($"_WithXMulti: {pos._WithXMulti(3f)} // X分量乘3");
            Debug.Log($"_WithZMulti: {pos._WithZMulti(4f)} // Z分量乘4");
