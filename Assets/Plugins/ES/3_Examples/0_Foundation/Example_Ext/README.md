...
**使用说明**
- 示例脚本位于 `Assets/Plugins/ES/3_Examples/0_Foundation/Example_Ext/`，可将对应脚本挂到场景中的 GameObject 上运行查看效果。
...
- **ExtForColor.cs**: Color 处理（查到的方法）
  ...
  - `_Invert/_IsApproximatelyEachRGBA/_IsApproximatelyTogether/_GetGrayscale/_RandomColorRef/_AsGrayscale/_WithRGBMulti/_SetRGBMulti/_WithRGBMultiRef`
