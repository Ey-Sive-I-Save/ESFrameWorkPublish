...
```text
检查 previewIdleClip、previewModel、previewAvatar、previewFallbackMaterial，确认资产包窗口通过 PreviewWorkflow 读取配置。
```

## ContractCompleteness

```yaml
commandId: state.animation-preview.review
writeMode: read-only
