...
```text
搜索 InitializeOnLoad/DidReloadScripts/EditorApplication.update/LoadImage/AssetPreview/FindAssets，判断 ReloadDomain 内存峰值。
```

## ContractCompleteness

```yaml
commandId: compile.reload-memory.review
writeMode: read-only
