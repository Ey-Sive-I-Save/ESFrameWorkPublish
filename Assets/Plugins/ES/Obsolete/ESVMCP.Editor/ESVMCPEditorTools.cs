...
namespace ES.Obsolete.VMCP.Editor
{
    ...
    public static class ESVMCPEditorTools
    {
        ...
        [MenuItem(MenuRoot + "系统管理/【一键安装】", priority = 200)]
        ...
        [MenuItem(MenuRoot + "资产管理/导出记忆", priority = 20)]
        ...
        [MenuItem(MenuRoot + "系统管理/【查看状态】", priority = 201)]
        ...
        [MenuItem(MenuRoot + "资产管理/创建文件夹结构", priority = 21)]
        ...
        [MenuItem(MenuRoot + "资产管理/创建配置资产", priority = 22)]
        ...
        [MenuItem(MenuRoot + "资产管理/创建记忆资产", priority = 23)]
        ...
        [MenuItem(MenuRoot + "资产管理/在场景中添加记忆组件", priority = 24)]
        ...
        [MenuItem(MenuRoot + "系统管理/打开文件夹/打开Input文件夹", priority = 210)]
        ...
        [MenuItem(MenuRoot + "系统管理/打开文件夹/打开Archive文件夹", priority = 211)]
        ...
        [MenuItem(MenuRoot + "系统管理/打开文件夹/打开Memory文件夹", priority = 212)]
        ...
        [MenuItem(MenuRoot + "系统管理/打开文件夹/打开Logs文件夹", priority = 213)]
        ...
        [MenuItem(MenuRoot + "系统管理/资产/选择配置资产", priority = 220)]
        ...
        [MenuItem(MenuRoot + "系统管理/资产/选择记忆资产", priority = 221)]
        ...
        [MenuItem(MenuRoot + "资产管理/创建示例JSON", priority = 25)]
