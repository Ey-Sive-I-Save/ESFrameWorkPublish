...
public class RuntimeWatchCaseSceneInstaller : EditorInvoker_Level2
{
    ...
    private static void InstallOrUpdate(bool onlyKnownShowcaseScene)
    {
        ...
        RuntimeWatchCase_1_BasicTypes basic = CreateOrAttach<RuntimeWatchCase_1_BasicTypes>(parent.transform, "01 · 实时数据与基础类型", new Vector3(-4f, 0f, 0f), ref changed);
        CreateOrAttach<RuntimeWatchCase_2_Methods>(parent.transform, "02 · 安全方法调用", new Vector3(-2f, 0f, 0f), ref changed);
        CreateOrAttach<RuntimeWatchCase_3_FilterAndNested>(parent.transform, "03 · 搜索筛选与嵌套", Vector3.zero, ref changed);
        RuntimeWatchCase_4_UnityTypes unityTypes = CreateOrAttach<RuntimeWatchCase_4_UnityTypes>(parent.transform, "04 · Unity 类型与引用", new Vector3(2f, 0f, 0f), ref changed);
        CreateOrAttach<RuntimeWatchCase_5_Diagnostics>(parent.transform, "05 · 异常与性能诊断", new Vector3(4f, 0f, 0f), ref changed);
