...
namespace ES
{
    public sealed class ESInputConfig : ESSO, IESInputRuntimeConfigSource
    {
        ...
        public int ActionCount => actions == null ? 0 : actions.Count;
        ...
        public void ResetDefaultGameplayConfig()
        {
            ...
            UnityEditor.Undo.RecordObject(this, "重置输入默认配置");
#endif
            ApplyDefaultGameplayConfig();
#if UNITY_EDITOR
            UnityEditor.EditorUtility.SetDirty(this);
#endif
        }

        public void ApplyDefaultGameplayConfig()
        {
    ...
    public static class ESInputActionDefineExtensions
    {
        ...
        {
            return config.WithTrigger(ESInputTriggerFeature.Pressed | ESInputTriggerFeature.LongPress, pressPolicy, longPressDuration);
        }
        ...
        public static ESInputActionDefine WithClickAndDoublePress(
            ...
            ESInputPressPolicy pressPolicy = ESInputPressPolicy.PressedImmediate)
        {
            return config.WithTrigger(ESInputTriggerFeature.Pressed | ESInputTriggerFeature.DoublePress, pressPolicy, 0.5f, doublePressWindow);
        }
        ...
        public static ESInputActionDefine WithUIOnlyVirtualBinding(this ESInputActionDefine config, string controlId, string schemeId = ESInputSchemeIds.Touch)
        {
            if (config == null)
                return null;
