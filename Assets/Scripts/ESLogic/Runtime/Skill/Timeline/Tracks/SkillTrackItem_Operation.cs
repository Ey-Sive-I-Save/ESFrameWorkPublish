...
namespace ES
{
    ...
    public sealed class SkillOperationTrackRuntimePlayer : ISkillRuntimeTrackPlayer
    {
        ...
        {
            if (ownsTarget && trackState.UserData is ESRuntimeTargetPack target && target != null && !target.IsRecycled)
    ...
    public sealed class SkillOperationClipRuntimePlayer : ISkillRuntimeClipPlayer
    {
        ...
        {
            ESRuntimeTargetPack target = clipState.UserData as ESRuntimeTargetPack;
            ...
            if (ownsTarget && target != null && !target.IsRecycled)
                target.ForcePushToPool();
