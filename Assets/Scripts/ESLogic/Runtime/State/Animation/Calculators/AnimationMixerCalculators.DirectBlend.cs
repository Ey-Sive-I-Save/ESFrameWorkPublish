      ...
      // ==================== Direct混合 ====================
        ...
        public class StateAnimationMixCalculatorForDirectBlend : StateAnimationMixCalculator
        {
            ...
            public override void ResetRuntimeForReuse(AnimationCalculatorRuntime runtime)
            {
                ...
                if (runtime == null || !runtime.mixer.IsValid() || clips == null)
                    return;
                ...
                for (int i = 0; i < clips.Length; i++)
                {
                    ...
                    float weight = clips[i] != null ? clips[i].defaultWeight : 0f;
                    if (runtime.currentWeights != null && i < runtime.currentWeights.Length)
                        runtime.currentWeights[i] = weight;
                    if (runtime.targetWeights != null && i < runtime.targetWeights.Length)
                        runtime.targetWeights[i] = weight;
                    if (runtime.weightVelocities != null && i < runtime.weightVelocities.Length)
