namespace ES
{
    ...
    public static class StateFailureReasons
    {
        ...
        public const string PipelineNotFound = "层级不存在";
        public const string PipelineDisabled = "层级未启用";
        public const string InvalidPipelineIndex = "层级索引非法";
        public const string SupportFlagsNotSatisfied = "支持标记条件未满足";
        public const string CrossPipelineConflict = "跨层级冲突";
