...
namespace ES
{
    ...
    {
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置", Order = 100)]
        [FoldoutGroup("DriverLayout/高级设置/四肢IK自动添加")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/接地IK自动添加")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/注视IK自动添加")]
        [LabelText("LookAtIK")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/瞄准IK自动添加")]
        [LabelText("AimIK")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/全身IK自动添加")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/受击反馈自动添加")]
        ...
        [PropertyOrder(10)]
        [TabGroup("DriverLayout", "高级设置")]
        [FoldoutGroup("DriverLayout/高级设置/后坐力自动添加")]
        [LabelText("Recoil")]
