...
namespace ES
{
    public sealed partial class StateFinalIKDriver
    {
        ...
        [FoldoutGroup("DriverLayout/公共部分/四肢IK", Expanded = false)]
        ...
        [PropertyOrder(0)]
        [TabGroup("DriverLayout", "公共部分")]
        [FoldoutGroup("DriverLayout/公共部分/接地IK", Expanded = false)]
        ...
        [PropertyOrder(0)]
        [TabGroup("DriverLayout", "公共部分")]
        [FoldoutGroup("DriverLayout/公共部分/注视IK", Expanded = false)]
        ...
        [PropertyOrder(0)]
        [TabGroup("DriverLayout", "公共部分")]
        [FoldoutGroup("DriverLayout/公共部分/全身IK", Expanded = false)]
        ...
        [PropertyOrder(50)]
        [BoxGroup("DriverLayout/测试工具/实时权重测试盒", ShowLabel = false)]
        ...
        [PropertyOrder(51)]
        [BoxGroup("DriverLayout/测试工具/实时权重测试盒", ShowLabel = false)]
        [TitleGroup("DriverLayout/测试工具/实时权重测试盒/实时权重测试")]
        [HorizontalGroup("DriverLayout/测试工具/实时权重测试盒/实时权重测试/四肢", LabelWidth = 70)]
        [LabelText("左手")]
        [Range(0f, 1f)]
        ...
        [BoxGroup("DriverLayout/测试工具/实时权重测试盒", ShowLabel = false)]
        [TitleGroup("DriverLayout/测试工具/实时权重测试盒/实时权重测试")]
        [HorizontalGroup("DriverLayout/测试工具/实时权重测试盒/实时权重测试/注视瞄准", LabelWidth = 70)]
        [LabelText("注视权重")]
        [Range(0f, 1f)]
        [ShowIf("enableRealtimeWeightTest")]
        ...
        [LabelText("注视目标")]
        [ShowIf("enableRealtimeWeightTest")]
        [SerializeField] private Transform realtimeLookAtTarget = null;
        ...
        [LabelText("瞄准目标")]
        [ShowIf("enableRealtimeWeightTest")]
        [SerializeField] private Transform realtimeAimTarget = null;
    }
}
