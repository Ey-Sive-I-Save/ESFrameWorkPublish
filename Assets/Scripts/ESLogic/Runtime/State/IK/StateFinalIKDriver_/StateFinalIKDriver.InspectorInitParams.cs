...
namespace ES
{
    public sealed partial class StateFinalIKDriver
    {
        ...
        [PropertyOrder(30)]
        [FoldoutGroup("DriverLayout/公共部分/注视IK")]
        ...
        [PropertyOrder(30)]
        [FoldoutGroup("DriverLayout/公共部分/接地IK")]
        [LabelText("权重平滑时长 (秒)")]
        ...
        [PropertyOrder(30)]
        [FoldoutGroup("DriverLayout/公共部分/四肢IK")]
        [LabelText("权重平滑时长 (秒)")]
        ...
        [PropertyOrder(35)]
        [FoldoutGroup("DriverLayout/公共部分/四肢IK")]
        [HorizontalGroup("DriverLayout/公共部分/四肢IK/HW", LabelWidth = 80)]
        [LabelText("头部权重")]
