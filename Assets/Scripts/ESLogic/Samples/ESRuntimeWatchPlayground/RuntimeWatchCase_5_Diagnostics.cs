...
namespace ES
{
    ...
    public class RuntimeWatchCase_5_Diagnostics : MonoBehaviour
    {
        ...
        [ESRuntimeWatch("案例/5 控制", "显示观察项", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("显示观察项")]
        public bool Visible
        {
            get => visible;
        ...
        [ESRuntimeWatch("案例/5 控制", "实时更新", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("实时更新")]
        ...
        [ESRuntimeWatch("案例/5 工业诊断", "诊断状态", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("诊断状态")]
        ...
        [ESRuntimeWatch("案例/5 工业诊断", "实时脉冲", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("实时脉冲")]
        public float Pulse => pulse;

        [ESRuntimeWatch("案例/5 工业诊断", "瞬时峰值", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("瞬时峰值")]
        public int TransientSpike => transientSpike;

        [ESRuntimeWatch("案例/5 工业诊断", "操作次数", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("操作次数")]
        public int OperationCount => operationCount;

        [ESRuntimeWatch("案例/5 工业诊断", "最近操作", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("最近操作")]
        public string LastOperation => lastOperation;

        [ESRuntimeWatch("案例/5 性能诊断", "受控慢 Getter", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        ...
        [ESRuntimeWatch("案例/5 异常诊断", "受控读取异常", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("受控读取异常")]
        ...
        [ESRuntimeWatch("案例/5 诊断操作", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [Button("切换慢 Getter")]
        ...
        [ESRuntimeWatch("案例/5 诊断操作", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [Button("切换读取异常")]
        [LabelText("切换读取异常")]
        ...
        [ESRuntimeWatch("案例/5 控制", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [Button("切换实时更新")]
        [LabelText("切换实时更新")]
