...
namespace ES
{
    ...
    public class RuntimeWatchVideoCase_1_BasicTypes : MonoBehaviour
    {
        ...
        [Title("可写基础类型")]
        [ESRuntimeWatch("视频案例/1 控制", "显示观察项", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("显示观察项")]
        public bool Visible
        {
            get => visible;
        ...
        [ESRuntimeWatch("视频案例/1 控制", "实时更新", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("实时更新")]
        ...
        [ESRuntimeWatch("视频案例/1 基础类型", "Enum 状态", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("Enum 状态")]
        ...
        [ESRuntimeWatch("视频案例/1 只读类型", "旋转 Y", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryScene)]
        [LabelText("旋转 Y")]
        public float Yaw => transform.eulerAngles.y;

        [ESRuntimeWatch("视频案例/1 可写属性", "可写属性 Int", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("可写属性 Int")]
        ...
        [ESRuntimeWatch("视频案例/1 控制", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [Button("切换实时更新")]
        [LabelText("切换实时更新")]
