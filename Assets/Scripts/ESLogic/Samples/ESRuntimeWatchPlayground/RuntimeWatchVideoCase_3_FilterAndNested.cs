...
namespace ES
{
    ...
    public class RuntimeWatchVideoCase_3_FilterAndNested : MonoBehaviour
    {
        ...
        private RuntimeWatchVideoNestedData nested = new RuntimeWatchVideoNestedData();

        [ESRuntimeWatch("视频案例/3 控制", "ShowIf 开关", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("ShowIf 开关")]
        ...
        [ESRuntimeWatch("视频案例/3 控制", "实时更新", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("实时更新")]
        ...
        [ESRuntimeWatch("视频案例/3 筛选", "根 Tag", showIf: "@this.showRuntime", category: ESRuntimeWatchAttribute.CategoryScene)]
        [LabelText("根 Tag")]
        public string RootTag => transform.root != null ? transform.root.tag : gameObject.tag;

        [ESRuntimeWatch("视频案例/3 筛选", "Tag 过滤演示", requiredTag: "Player", showIf: "@this.showRuntime", category: ESRuntimeWatchAttribute.CategoryCharacter)]
        [LabelText("Tag 过滤演示")]
        ...
        [ESRuntimeWatch("视频案例/3 控制", category: ESRuntimeWatchAttribute.CategoryTemporary)]
        [Button("切换临时分类")]
        [LabelText("切换临时分类")]
        ...
        [ESRuntimeWatch("视频案例/3 控制", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [Button("切换实时更新")]
        [LabelText("切换实时更新")]
        ...
        public class RuntimeWatchVideoNestedData
        {
            ...
            [ESRuntimeWatch("视频案例/3 嵌套/字段", "嵌套 Owner", showIf: "@this.visible", category: ESRuntimeWatchAttribute.CategoryDebug)]
            [LabelText("嵌套 Owner")]
