...
namespace ES
{
    ...
    public class RuntimeWatchVideoCase_4_UnityTypes : MonoBehaviour
    {
        ...
        [ESRuntimeWatch("视频案例/4 控制", "显示观察项", category: ESRuntimeWatchAttribute.CategoryDebug)]
        [LabelText("显示观察项")]
        public bool Visible
        {
            get => visible;
        ...
        [ESRuntimeWatch("视频案例/4 控制", "实时更新", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [LabelText("实时更新")]
        ...
        [ESRuntimeWatch("视频案例/4 控制", category: ESRuntimeWatchAttribute.CategoryPerformance)]
        [Button("切换实时更新")]
        [LabelText("切换实时更新")]
